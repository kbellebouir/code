...
namespace tp3
{
    ...
    public class VolPrive : Vol
    {
        ...
        public VolPrive(int numVol, string destination, Date dateDepart, int nombreRes, Avion avionChoisi, char categorieVol) : base(numVol, destination, dateDepart, nombreRes, avionChoisi, categorieVol)
        {
            repas = "oui";
            resSiege = "oui";
            servBar = "oui";
